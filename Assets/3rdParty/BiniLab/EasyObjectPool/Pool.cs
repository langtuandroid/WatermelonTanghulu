...
namespace ObjectPool
{
    class Pool
    {
        ...
        public Pool(string poolName, GameObject poolObjectPrefab, int initialCount, bool fixedSize, Transform parent = null)
        {
            ...
            {
                AddObjectToPool(NewObjectInstance(), parent);
            }
        }

        private void AddObjectToPool(PoolObject po, Transform parent = null)
        {
            //add to pool
        ...
        public GameObject NextAvailableObject(Vector3 position, Quaternion rotation, Transform transform)
        {
            PoolObject po = null;
        ...
        public void ReturnObjectToPool(PoolObject po, Transform transform)
        {
